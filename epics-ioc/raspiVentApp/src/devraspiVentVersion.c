...
#include "raspiVentVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = raspiVentVERSION;
...
static lsidset devraspiVentVersion = {
    5, NULL, NULL, NULL, NULL, read_string
};
epicsExportAddress(dset,devraspiVentVersion);
